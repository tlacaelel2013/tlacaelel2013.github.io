...
Filesystem.prototype.PDF = function(path) {
   // if (path == "") {
        path = "/home/user";
   //  }
    
   // download("/home/user/R.pdf", "Rplot.pdf", "application/octet-stream");
  //  download("/home/user/R.pdf", "Rplot.pdf", "application/pdf");
 //   download("/root/Plot_00.pdf");
    
    // download("/home/user/plots/R.pdf", "R-plot-00.pdf", "application/pdf");
    var arrayPath = path.split('/');
    message.Register("tar", function(d){download(d, "R.pdf", "application/pdf");} );
    message.Send("tar", path);
    // alert(/home/user/R.pdf);
    // var arrayPath = path.split('/');
    // message.Register("pdf", function(d){download(d, "Rplot.pdf", "application/octet-stream");} );
    // message.Send("pdf", path);
}
    ...
    Filesystem.prototype.TAR = function(path) {
        ...
        var arrayPath = path.split('/');
        message.Register("tar", function(d){download(d, arrayPath[arrayPath.length-1]+".pdf", "application/pdf");} );
        message.Send("tar", path);
        /*
        message.Register("tar", function(d){download(d, "Rplots.pdf", "application/x-pdf");} );
        message.Send("tar", path);
         */
     
    }
    
    Filesystem.prototype.SHOW = function show(img){
        ...
        _.getContext('2d').drawImage(img,0,0,228,228);
       }
    ...
    Filesystem.prototype.TAR = function(path) {
       // if (path == "") {
            path = "/home/user/R.pdf";
       // }
        var arrayPath = path.split('/');
     //   download("/home/user/R.pdf");
     //   function(d){download(d, "Rplots.pdf", "application/x-pdf");};
     //   download(d, "Rplots.pdf", "application/x-pdf");
        message.Register("tar", function(d){download(d, "Rplots.txt", "application/x-tar");} );
        message.Send("tar", path);
    }
     */
