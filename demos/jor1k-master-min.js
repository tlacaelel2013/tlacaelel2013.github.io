...
Filesystem.prototype.PDF = function(path) {
 ...
 //   message.Register("tar", function(d){download(d, "Plot_00.pdf", "application/octet-stream");} );
    message.Register("tar", function(d){download(d, "Plot_00.pdf", "application/pdf");} );
 ...
 /*
    ...
    Filesystem.prototype.TAR = function(path) {
        ...
        var arrayPath = path.split('/');
 //       message.Register("tar", function(d){download(d, arrayPath[arrayPath.length-1]+".tar", "application/octet-stream");} );
...
function Terminal(nrows, ncolumns, elemId) {
  ...
  //      this.context.font = "13px courier,fixed,swiss,monospace,sans-serif";
        this.context.font = "50px courier,fixed,swiss,monospace,sans-serif";
    } else {
        this.Table = ele;
